    ...
    return (
        <>
            <div className='w-[80%] m-auto flex sm:justify-between flex-col sm:flex-row  mt-20 p-4'>
                <div className='relative'><div className='h-[300px] w-[300px] bg-gray-500  border rotate-12 bg-opacity-30 absolute z-0 top-0 left-0'></div><img src={aboutimg} className='h-[300px] w-[300px] object-center object-cover relative z-90' alt="" /></div>
                <div className=' w-[90%] sm:w-[40%] my-[4em] sm:my-0 flex flex-col'><h1 className='text-2xl font-bold mb-4'>Get the Best Design For your Tradition </h1>
                    <div >
            ...
            <blockquote class="  my-14 text-lg italic font-semibold text-gray-900 dark:text-white  flex justify-between flex-col w-[96%] sm:w-[50%] m-auto ">
